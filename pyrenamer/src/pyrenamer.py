...
class pyRenamer:
    ...
    def __init__(self, rootdir=None, startdir=None, debug=False):
        ...
        self.main_hpaned = self.glade_tree.get_object("main_hpaned")
        self.selected_files, selected_files_scrolled = self.create_selected_files_treeview()


        self.statusbar = self.glade_tree.get_object("statusbar")
        self.notebook = self.glade_tree.get_object("notebook")
        self.clear_button = self.glade_tree.get_object("clear_button")
        self.preview_button = self.glade_tree.get_object("preview_button")
        self.rename_button = self.glade_tree.get_object("rename_button")

        self.original_pattern = self.glade_tree.get_object("original_pattern")
        self.renamed_pattern = self.glade_tree.get_object("renamed_pattern")
        self.original_pattern_combo = self.glade_tree.get_object("original_pattern_combo")
        self.renamed_pattern_combo = self.glade_tree.get_object("renamed_pattern_combo")

        self.subs_spaces = self.glade_tree.get_object("subs_spaces")
        self.subs_capitalization = self.glade_tree.get_object("subs_capitalization")
        self.subs_spaces_combo = self.glade_tree.get_object("subs_spaces_combo")
        self.subs_capitalization_combo = self.glade_tree.get_object("subs_capitalization_combo")
        self.subs_replace = self.glade_tree.get_object("subs_replace")
        self.subs_replace_orig = self.glade_tree.get_object("subs_replace_orig")
        self.subs_replace_new = self.glade_tree.get_object("subs_replace_new")
        self.subs_replace_label = self.glade_tree.get_object("subs_replace_label")
        self.subs_accents = self.glade_tree.get_object("subs_accents")
        self.subs_duplicated = self.glade_tree.get_object("subs_duplicated")

        self.insert_radio = self.glade_tree.get_object("insert_radio")
        self.insert_entry = self.glade_tree.get_object("insert_entry")
        self.insert_pos = self.glade_tree.get_object("insert_pos")
        self.insert_end = self.glade_tree.get_object("insert_end")

        self.delete_radio = self.glade_tree.get_object("delete_radio")
        self.delete_from = self.glade_tree.get_object("delete_from")
        self.delete_to = self.glade_tree.get_object("delete_to")

        self.manual = self.glade_tree.get_object("manual")
        self.menu_clear_preview = self.glade_tree.get_object("menu_clear_preview")
        self.menu_rename = self.glade_tree.get_object("menu_rename")
        self.menu_show_options = self.glade_tree.get_object("menu_show_options")

        self.menu_undo = self.glade_tree.get_object("menu_undo")
        self.menu_redo = self.glade_tree.get_object("menu_redo")

        self.menu_music = self.glade_tree.get_object("menu_music")

        self.images_original_pattern = self.glade_tree.get_object("images_original_pattern")
        self.images_renamed_pattern = self.glade_tree.get_object("images_renamed_pattern")
        self.images_original_pattern_combo = self.glade_tree.get_object("images_original_pattern_combo")
        self.images_renamed_pattern_combo = self.glade_tree.get_object("images_renamed_pattern_combo")

        self.music_original_pattern = self.glade_tree.get_object("music_original_pattern")
        self.music_renamed_pattern = self.glade_tree.get_object("music_renamed_pattern")
        self.music_original_pattern_combo = self.glade_tree.get_object("music_original_pattern_combo")
        self.music_renamed_pattern_combo = self.glade_tree.get_object("music_renamed_pattern_combo")

        # Options panel
        self.file_pattern = self.glade_tree.get_object("file_pattern")
        self.add_recursive = self.glade_tree.get_object("add_recursive")
        self.options_button = self.glade_tree.get_object("options_button")
        self.options_vbox = self.glade_tree.get_object("options_vbox")
        self.options_label = self.glade_tree.get_object("options_label")
        self.options_close_button = self.glade_tree.get_object("options_close_button")
        self.filedir_combo = self.glade_tree.get_object("filedir_combo")
        self.pattern_hbox = self.glade_tree.get_object("pattern_hbox")
        self.add_recursive = self.glade_tree.get_object("add_recursive")
        self.extensions_check = self.glade_tree.get_object("extensions_check")
        self.autopreview_check = self.glade_tree.get_object("autopreview_check")
